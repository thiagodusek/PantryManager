...
object OpenAIConfig {
    ...
    fun getApiKey(): String {
        // Opção 1: Via BuildConfig (descomente quando configurar)
        ...
        // Opção 3: Chave padrão (deve ser configurada via strings.xml ou variável de ambiente)
        return "YOUR_OPENAI_API_KEY_HERE" // Configure via strings.xml ou variável de ambiente
    }
    ...
    fun isApiKeyConfigured(): Boolean {
        val key = getApiKey()
        return key.startsWith("sk-") && key.isNotBlank()
    }
}
